...
const Aniversario111 = () => {
  ...
  const photos = [
    {
      src: "/actividades/aniversario111/1.jpg",
      width: 1,
      height: 1,
      aspectRatio: 1
    },
    {
      src: "/actividades/aniversario111/2.jpg",
      width: 2,
      height: 3,
      aspectRatio: 0.67
    },
    {
      src: "/actividades/aniversario111/3.jpg",
      width: 3,
      height: 2,
      aspectRatio: 1.5
    },
    {
      src: "/actividades/aniversario111/4.jpg",
      width: 3,
      height: 2,
      aspectRatio: 1.5
    },
    {
      src: "/actividades/aniversario111/5.jpg",
      width: 3,
      height: 2,
      aspectRatio: 1.5
    },
    {
      src: "/actividades/aniversario111/6.jpg",
      width: 3,
      height: 2,
      aspectRatio: 1.5
    },
    {
      src: "/actividades/aniversario111/7.jpg",
      width: 3,
      height: 2,
      aspectRatio: 1.5
    },
    {
      src: "/actividades/aniversario111/8.jpg",
      width: 3,
      height: 2,
      aspectRatio: 1.5
    }
