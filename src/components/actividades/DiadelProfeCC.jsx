...
const DiadelProfeCC = () => {
  ...
  const photos = [
    {
      src: "/actividades/diadelprofesor/casacentral/1.jpg",
      width: 1,
      height: 1,
      aspectRatio: 1
    },
    {
      src: "/actividades/diadelprofesor/casacentral/2.jpg",
      width: 2,
      height: 3,
      aspectRatio: 0.67
    },
    {
      src: "/actividades/diadelprofesor/casacentral/3.jpg",
      width: 3,
      height: 2,
      aspectRatio: 1.5
    },
    {
      src: "/actividades/diadelprofesor/casacentral/4.jpg",
      width: 3,
      height: 2,
      aspectRatio: 1.5
    },
    {
      src: "/actividades/diadelprofesor/casacentral/5.jpg",
      width: 3,
      height: 2,
      aspectRatio: 1.5
    },
    {
      src: "/actividades/diadelprofesor/casacentral/6.jpg",
      width: 3,
      height: 2,
      aspectRatio: 1.5
    },
    {
      src: "/actividades/diadelprofesor/casacentral/7.jpg",
      width: 3,
      height: 2,
      aspectRatio: 1.5
    },
    {
      src: "/actividades/diadelprofesor/casacentral/8.jpg",
      width: 3,
      height: 2,
      aspectRatio: 1.5
    }
