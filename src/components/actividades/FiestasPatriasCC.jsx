...
const FiestasPatriasCC = () => {
  ...
  const photos = [
    {
      src: "/actividades/fiestas-patrias/casa-central/1.jpg",
      width: 1,
      height: 1,
      aspectRatio: 1
    },
    {
      src: "/actividades/fiestas-patrias/casa-central/2.jpg",
      width: 2,
      height: 3,
      aspectRatio: 0.67
    },
    {
      src: "/actividades/fiestas-patrias/casa-central/3.jpg",
      width: 3,
      height: 2,
      aspectRatio: 1.5
    },
    {
      src: "/actividades/fiestas-patrias/casa-central/4.jpg",
      width: 3,
      height: 2,
      aspectRatio: 1.5
    },
    {
      src: "/actividades/fiestas-patrias/casa-central/5.jpg",
      width: 3,
      height: 2,
      aspectRatio: 1.5
    },
    {
      src: "/actividades/fiestas-patrias/casa-central/6.jpg",
      width: 3,
      height: 2,
      aspectRatio: 1.5
    },
    {
      src: "/actividades/fiestas-patrias/casa-central/7.jpg",
      width: 3,
      height: 2,
      aspectRatio: 1.5
    },
    {
      src: "/actividades/fiestas-patrias/casa-central/8.jpg",
      width: 3,
      height: 2,
      aspectRatio: 1.5
    }
