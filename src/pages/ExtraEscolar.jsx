...
const ExtraEscolar = () => {
  ...
  const photos = [
    ...
    {
      src: "/extraescolar/artesmarciales.jpg",
      width: 2,
      height: 3,
      aspectRatio: 0.67,
